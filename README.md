...
```javascript
import saxpy from 'https://cdn.jsdelivr.net/gh/stdlib-js/blas-base-saxpy@v0.0.8-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/blas-base-saxpy/actions/workflows/test.yml/badge.svg?branch=v0.0.8
[test-url]: https://github.com/stdlib-js/blas-base-saxpy/actions/workflows/test.yml?query=branch:v0.0.8
